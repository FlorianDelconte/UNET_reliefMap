...
name= "cross-validationv3/test-2.hdf5"
...
train_dir_input 	= os.path.join(os.getcwd(), '..','crossValidationv3','data4_2nd', train_folder, 'input')
valid_dir_input 	= os.path.join(os.getcwd(), '..','crossValidationv3','data4_2nd', valid_folder, 'input')
test_dir_input 		= os.path.join(os.getcwd(),'..','crossValidationv3','data4_2nd', 'test', 'input')

train_dir_output 	= os.path.join(os.getcwd(), '..','crossValidationv3','data4_2nd', train_folder, 'output')
valid_dir_output	= os.path.join(os.getcwd(), '..','crossValidationv3','data4_2nd',valid_folder, 'output')
test_dir_output 	= os.path.join(os.getcwd(),'..','crossValidationv3','data4_2nd', 'test', 'output')
...
# ----- #
#########
def unet(pretrained_weights = None,input_size = (None, None, channels)):
	...
	up6 = Conv2D(numFilt*8, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv5))
	...
	model.compile(optimizer = Adam(lr = 5e-5), loss = 'binary_crossentropy', metrics = ['accuracy'])#1e-4
