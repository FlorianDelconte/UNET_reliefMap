...
def unet(pretrained_weights = None,input_size = (height, width, channels)):
	...
	up6 = Conv2D(numFilt*8, 2,activation = my_leaky_relu, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv5))
	...
	'''conv1 = Conv2D(numFilt, 3,activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(inputs)# activation = 'relu'###tf.nn.leaky_relu
