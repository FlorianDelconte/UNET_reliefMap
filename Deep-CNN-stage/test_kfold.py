...
prefix_name_model="leakyReLu-v4"
path_model = os.path.join(os.getcwd(),'model', 'save','repartition-data9','TEST_article')
...
def main(argv):
    ...
    '''for i in range(nb_fold):
        path_test_input     = os.path.join(os.getcwd(),'..','crossValidationv9','data_'+str(i), 'test', 'input')
        path_test_gt        = os.path.join(os.getcwd(),'..','crossValidationv9','data_'+str(i), 'test', 'gt')
    ...
    #TO TEST normal
    path_test_input     = os.path.join(os.getcwd(),'..','repartitionData9','test', 'input')
    path_test_gt        = os.path.join(os.getcwd(),'..','repartitionData9','test', 'gt')
